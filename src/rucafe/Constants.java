...
public class Constants {
    ...
    public static final double COFFEE_UPDGRADE_PRICE = 0.5;
    public static final double COFFEE_SHORT_PRICE = COFFEE_BASE_PRICE;
    public static final double COFFEE_TALL_PRICE = COFFEE_SHORT_PRICE + COFFEE_UPDGRADE_PRICE;
    public static final double COFFEE_GRANDE_PRICE = COFFEE_TALL_PRICE + COFFEE_UPDGRADE_PRICE;
    public static final double COFFEE_VENTI_PRICE = COFFEE_GRANDE_PRICE + COFFEE_UPDGRADE_PRICE;
